...
RouterOSMCPSharp is licensed under the MIT License (see `LICENSE`). It depends
...
"MikroTik" and "RouterOS" are trademarks of MikroTikls SIA. Use of these names
in this project does not imply endorsement by, or affiliation with, MikroTik.
